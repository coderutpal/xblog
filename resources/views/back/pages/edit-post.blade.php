...
@section('content')
    ...
    <form action="{{ route('admin.update_post', ['post_id' => $post->id]) }}" method="POST" enctype="multipart/form-data"
        autocomplete="off" id="updatePostForm">
        @csrf
        <div class="row">
            <div class="col-md-9">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="" cols="30" rows="10" class="form-control"
                                placeholder="Post meta description"> {{ $post->meta_description }} </textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-block mb-3" style="max-width: 250px">
                            <img id="featured_image_preview"
                                src="{{ $post->featured_image ? asset('images/posts/thumbs/thumb_' . $post->featured_image) : '' }}"
                                class="img-thumbnail"
                                style="width:100%; {{ $post->featured_image ? '' : 'display:none;' }}">
                        </div>
