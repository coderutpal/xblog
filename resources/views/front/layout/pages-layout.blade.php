                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link world" href="#">World <i class="fa fa-angle-down"
                                        aria-hidden="true"></i></a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s15.jpg" alt="">
                                                        </a>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s23.jpg" alt="">
                                                        </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link sport" href="#">Sport <i class="fa fa-angle-down"
                                        aria-hidden="true"></i></a>
                                <div class="mega-posts-menu">
                                    <div class="posts-line">
                                        <ul class="filter-list">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s30.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="category category-sport">Tennis</a>
                                                    </div>
                                                    <h2><a href="single-post.html">Travelling is part of our life</a>
                                                    </h2>
                                                    <ul class="post-tags">
                                                        <li><i class="lnr lnr-user"></i>by <a href="#">John
                                                                Doe</a></li>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s31.jpg" alt="">
                                                        </a>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s32.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="category category-sport">winter
                                                            sports</a>
                                                    </div>
                                                    <h2><a href="single-post.html">Travelling is part of our life</a>
                                                    </h2>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s29.jpg" alt="">
                                                        </a>
                                                        <a href="#"
                                                            class="category category-sport">Basketball</a>
                                                    </div>
                                                    <h2><a href="single-post.html">Travelling is part of our life</a>
                                                    </h2>
                                                    <ul class="post-tags">
                            ...
                            <li class="nav-item">
                                <a class="nav-link tech" href="#">Tech <i class="fa fa-angle-down"
                                        aria-hidden="true"></i></a>
                                <div class="mega-posts-menu">
                                    <div class="posts-line">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s37.jpg" alt="">
                                                        </a>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s38.jpg" alt="">
                                                        </a>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s39.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="category category-tech">Tech</a>
                                                    </div>
                                                    <h2><a href="single-post.html">Travelling is part of our life</a>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="news-post standart-post">
                                                    <div class="post-image">
                                                        <a href="single-post">
                                                            <img src="/front/upload/blog/s2.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="category category-tech">Tech</a>
                                                    </div>
                                                    <h2><a href="single-post.html">Travelling is part of our life</a>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="posts-block">
                            ...
                            <div class="slider-news">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li>
                                            <img alt="" src="/front/upload/blog/1.jpg" />
                                            <div class="slider-caption">
                                                <a href="#" class="category category-world">
                                                    Business
                                                </a>
                                                <h2><a href="single-post.html">Low Taxes has increased new
                                                        Businesses</a></h2>
                                        ...
                                        <li>
                                            <img alt="" src="/front/upload/blog/2.jpg" />
                                            <div class="slider-caption">
                                        ...
                                        <li>
                                            <img alt="" src="/front/upload/blog/3.jpg" />
                                            <div class="slider-caption">
                                                <a href="#" class="category category-world">
                                                    Business
                                                </a>
                                                <h2><a href="single-post.html">Economy has raised in EU</a></h2>
                                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                                                    officia deserunt mollit anim id est laborum.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <img alt="" src="/front/upload/blog/4.jpg" />
                                            <div class="slider-caption">
                                                <a href="#" class="category category-fashion">
                                                    Fashion
                                                </a>
                                                <h2><a href="single-post.html">Fashion Trend last century.</a></h2>
                                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                                                    officia deserunt mollit anim id est laborum.</p>
                                            </div>
                                        </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="news-post standart-post">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s4.jpg" alt="">
                                            </a>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="news-post standart-post">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s3.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-sm-6">
                                    <div class="news-post standart-post">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s5.jpg" alt="">
                                            </a>
                                            <a href="#" class="category category-food">Food</a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="news-post standart-post">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s6.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-sm-6">
                                    <div class="news-post standart-post">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s8.jpg" alt="">
                                            </a>
                                            <a href="#" class="category category-tech">Tech</a>
                                        </div>
                                ...
                                <div class="owl-carousel" data-num="3">
                                    ...
                                    <div class="item">
                                        <div class="news-post standart-post">
                                            <div class="post-image">
                                                <a href="single-post">
                                                    <img src="/front/upload/blog/s24.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="item">
                                        <div class="news-post standart-post">
                                            <div class="post-image">
                                                <a href="single-post">
                                                    <img src="/front/upload/blog/s26.jpg" alt="">
                                                </a>
                                                <a href="#" class="category category-food">food</a>
                                            </div>
                                            <h2><a href="single-post.html">Traditional food</a></h2>
                                    ...
                                    <div class="item">
                                        <div class="news-post standart-post">
                                            <div class="post-image">
                                                <a href="single-post">
                                                    <img src="/front/upload/blog/s27.jpg" alt="">
                                                </a>
                        ...
                        <div class="advertisement">
                            <a href="#"><img src="/front/upload/addsense/620x80grey.jpg" alt=""></a>
                        </div>
                        <!-- End Advertisement -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="news-post standart-post">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s13.jpg" alt="">
                                            </a>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="news-post thumb-post">
                                                <div class="post-image">
                                                    <a href="single-post">
                                                        <img src="/front/upload/blog/s18.jpg" alt="">
                                                    </a>
                                                </div>
                                                <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit
                                                        in voluptate</a></h2>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="news-post thumb-post">
                                                <div class="post-image">
                                                    <a href="single-post">
                                                        <img src="/front/upload/blog/s20.jpg" alt="">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="news-post thumb-post">
                                                ...
                                                <h2><a href="single-post.html">Consectetur adipisicing elit, sed do
                                                        eiusmod</a></h2>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="news-post thumb-post">
                                                ...
                                                <h2><a href="single-post.html">Culpa qui officia deserunt mollit anim
                                                        id est</a></h2>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="news-post article-post">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="post-image">
                                            <a href="single-post">
                                                <img src="/front/upload/blog/s7.jpg" alt="">
                                            </a>
                        ...
                        <div class="sidebar theiaStickySidebar">
                            ...
                            <div class="widget slider-widget">
                                ...
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li>
                                            <img alt="" src="/front/upload/blog/s14.jpg" />
                                            <div class="slider-caption">
                                                <a href="#" class="category category-tech">Tech</a>
                                                <h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
                                                <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>by <a href="#">John Doe</a>
                                                    </li>
                                                    <li><a href="#"><i class="lnr lnr-book"></i><span>23
                                                                comments</span></a></li>
                                                    <li><i class="lnr lnr-eye"></i>872 Views</li>
                                        ...
                                        <li>
                                            <img alt="" src="/front/upload/blog/s13.jpg" />
                                            <div class="slider-caption">
                                                <a href="#" class="category category-fashion">Fashion</a>
                                                <h2><a href="single-post.html">Autumn wear ...</a></h2>
                                                <ul class="post-tags">
                                        ...
                                        <li>
                                            <img alt="" src="/front/upload/blog/s26.jpg" />
                                            <div class="slider-caption">
                                                <a href="#" class="category category-world">Business</a>
                                ...
                                <ul class="small-posts">
                                    <li>
                                        <a href="single-post.html">
                                            <img src="/front/upload/blog/th1.jpg" alt="">
                                        </a>
                                        <div class="post-cont">
                                            <h2><a href="single-post.html">New alternatives are more productive</a>
                                            </h2>
                                    ...
                                    <li>
                                        <a href="single-post.html">
                                            <img src="/front/upload/blog/th2.jpg" alt="">
                                        </a>
                                        <div class="post-cont">
                                            <h2><a href="single-post.html">Vue js new javascript Framework</a></h2>
                                            <ul class="post-tags">
                            ...
                            <div class="advertisement">
                                <a href="#"><img src="/front/upload/addsense/300x250.jpg" alt=""></a>
                            </div>
                            ...
                            <div class="widget tabs-widget">
                                <div class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-recent-tab" data-toggle="tab"
                                        href="#nav-recent" role="tab" aria-controls="nav-recent"
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-popular" role="tabpanel"
                                        ...
                                        <ul class="small-posts">
                                            <li>
                                                ...
                                                <div class="post-cont">
                                                    <h2><a href="single-post.html">New alternatives are more
                                                            productive</a></h2>
                                                    <ul class="post-tags">
                                            ...
                                            <li>
                                                ...
                                                <div class="post-cont">
                                                    <h2><a href="single-post.html">Vue js new javascript Framework</a>
                                                    </h2>
                                                    <ul class="post-tags">
                                                        <li><i class="lnr lnr-user"></i>by <a href="#">Besim
                                                                Dauti</a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                            <li>
                                                <a href="single-post.html">
                                                    <img src="/front/upload/blog/th7.jpg" alt="">
                                                </a>
                                                <div class="post-cont">
                                                    <h2><a href="single-post.html">Eating traditional food is more
                                                            healthy</a></h2>
                                                    <ul class="post-tags">
                                                        <li><i class="lnr lnr-user"></i>by <a href="#">Admin
                                                                Mag</a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                            <li>
                                                <a href="single-post.html">
                                                    <img src="/front/upload/blog/th8.jpg" alt="">
                                                </a>
                                                <div class="post-cont">
                                                    <h2><a href="single-post.html">Visiting antic countries is John Doe
                                                            hobby.</a></h2>
                                                    <ul class="post-tags">
                                                        <li><i class="lnr lnr-user"></i>by <a href="#">Helena
                                                                Doe</a></li>
                                                    </ul>
                                                </div>
                                            </li>
                                    ...
                                    <div class="tab-pane fade" id="nav-recent" role="tabpanel"
                                        ...
                                        <ul class="small-posts">
                                            <li>
                                                <a href="single-post.html">
                                                    <img src="/front/upload/blog/th9.jpg" alt="">
                                                </a>
                                                <div class="post-cont">
                                                    <h2><a href="single-post.html">New alternatives are more
                                                            productive</a></h2>
                                            ...
                                            <li>
                                                <a href="single-post.html">
                                                    <img src="/front/upload/blog/th10.jpg" alt="">
                                                </a>
                                                <div class="post-cont">
                                                    <h2><a href="single-post.html">Vue js new javascript Framework</a>
                                                    </h2>
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                            <div class="news-post thumb-post">
                                <div class="post-image">
                                    <a href="single-post">
                                        <img src="/front/upload/blog/s1.jpg" alt="">
                                    </a>
                                </div>
                                <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a>
                                </h2>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                            <div class="news-post thumb-post">
                                <div class="post-image">
                                    <a href="single-post">
                                        <img src="/front/upload/blog/s9.jpg" alt="">
                                    </a>
                                </div>
                                <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a>
                                </h2>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                            <div class="news-post thumb-post">
                                <div class="post-image">
                                    <a href="single-post">
                                        <img src="/front/upload/blog/s10.jpg" alt="">
                                    </a>
                                </div>
                                <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a>
                                </h2>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                            <div class="news-post thumb-post">
                                <div class="post-image">
                                    <a href="single-post">
                                        <img src="/front/upload/blog/s12.jpg" alt="">
                                    </a>
                                </div>
                                <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a>
                                </h2>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                            <div class="news-post thumb-post">
                                <div class="post-image">
                                    <a href="single-post">
                                        <img src="/front/upload/blog/s16.jpg" alt="">
                                    </a>
                                </div>
                                <h2><a href="single-post.html">Duis aute irure dolor in reprehenderit in voluptate</a>
                                </h2>
        ...
        <footer>
            <div class="container">
                ...
                <div class="down-footer">
                    ...
                    <p>&copy; Copyright By Nunforest 2017<a href="#" class="go-top"><i
