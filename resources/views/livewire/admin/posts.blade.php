    ...
    <div class="pd-20 card-box mb-30">
        <div class="row mb-20">
            <div class="col-md-4">
                ...
                <input wire:model.live="search" class="form-control" id="search" type="text"
                ...
                <tbody>
                    @forelse ($posts as $item)
                        <tr>
                            ...
                            <td scope="row">{{ $item->author->name }}</td>
                            <td scope="row">{{ $item->post_category->name }}</td>
                            <td scope="row">
                                @if ($item->visibility == 1)
                                    <span class="badge badge-pill badge-success"><i class="icon-copy ti-world"></i>
                                        Public</span>
                                @else
                                    <span class="badge badge-pill badge-warning"><i class="icon-copy ti-lock"></i>
                                        Private</span>
                                @endif
                            </td>
                            <td scope="row">
                                <div class="table-actions">
                                    <a href="" data-color="#265ed7" style="color: rgb(233, 89, 89)"><i
                                            class="icon-copy dw dw-edit-2"></i></a>
